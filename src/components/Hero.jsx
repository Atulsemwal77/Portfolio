 ...
 const Hero=()=>{
    return(
        <>  
        <div id="home" className="hero flex flex-col items-center gap-6 px-4 md:px-10 lg:px-20 text-center  ">
    {/* <img src={profile} alt="Profile" className="mt-10 w-40 h-40 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full object-cover" /> */}
    <img src={profile2} alt="Profile" className="mt-10 w-40 h-40 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full  " />
    
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight">
        I'm <span className="text1">Atul Semwal</span>, <br className="hidden md:block"/> 
    </h1>
    ...
    <p className="w-full sm:w-3/4 lg:w-1/2 text-lg md:text-xl leading-relaxed text-gray-300">
        I am a full-stack web developer, from Dehradun, Uttarakhand. I have completed a 3-month internship at NovaNectar Service Pvt Ltd.
    </p>
    ...
    <div className="flex flex-col sm:flex-row items-center gap-5 text-lg font-semibold mb-10">
        ...
        <button className="px-7 py-2 md:py-3 rounded-full border border-white hover:border-purple-500 transition duration-300">
            My Resume
        </button>
    </div>
</div>
